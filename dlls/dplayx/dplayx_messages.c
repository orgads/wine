...
static void *DP_MSG_ExpectReply( IDirectPlayImpl *This, DPSP_SENDDATA *data, DWORD dwWaitTime,
        WORD wReplyCommandId, void **lplpReplyHdr, void **lplpReplyMsg, DWORD *lpdwMsgBodySize );
static DWORD DP_MSG_ParseSuperPackedPlayer( IDirectPlayImpl* lpDP,
                                            LPBYTE lpPackedPlayer,
                                            LPPACKEDPLAYERDATA lpData,
                                            BOOL bIsGroup,
                                            BOOL bAnsi );
static DWORD DP_MSG_FillSuperPackedPlayer( IDirectPlayImpl* lpDP,
                                           LPDPLAYI_SUPERPACKEDPLAYER lpPackedPlayer,
                                           void *lpData,
                                           BOOL bIsGroup,
                                           BOOL bAnsi );
static DWORD DP_MSG_FillPackedPlayer( IDirectPlayImpl* lpDP,
                                      LPDPLAYI_PACKEDPLAYER lpPackedPlayer,
                                      void *lpData,
                                      BOOL bIsGroup,
                                      BOOL bAnsi );
static HRESULT DP_MSG_ParsePlayerEnumeration( IDirectPlayImpl* lpDP,
                                              LPBYTE lpMsg,
                                              LPVOID lpMsgHdr );
static DWORD DP_MSG_ParseSessionDesc( IDirectPlayImpl* lpDP,
...
HRESULT DP_MSG_PackMessage( IDirectPlayImpl* This, LPVOID* lpMsg,
...
HRESULT DP_MSG_SendCreatePlayer( IDirectPlayImpl* This, lpPlayerData lpData )
{
  LPBYTE                   lpMsg;
 ...
 */
BOOL DP_MSG_ReplyReceived( IDirectPlayImpl *This, WORD wCommandId, const void *lpcMsgHdr,
        const void *lpcMsgBody, DWORD dwMsgBodySize )
{
...
#define PLAYER_OR_GROUP( bIsGroup, lpData, field )        \
  ...
  lpPackedPlayer->Size  = sizeof(DPLAYI_SUPERPACKEDPLAYER) - sizeof(DWORD);
  ...
  offset = lpPackedPlayer->Size + sizeof(DWORD);
...
void DP_MSG_ReplyToEnumPlayersRequest( IDirectPlayImpl* lpDP,
                                       LPVOID* lplpReply,
                                       LPDWORD lpdwMsgSize )
{
